...
configRaces.set(
  RACE_HUMAN,
  {
    ...
    build: [UNIT_OUTPOST, UNIT_FORT, UNIT_FACTORY, UNIT_ASSEMBLY, UNIT_FIGHTER_BASE, UNIT_BOMBER_BASE],
...
configRaces.set(
  RACE_ALIEN,
  {
    ...
    build: [UNIT_MONUMENT, UNIT_FF_GENERATOR, UNIT_SPIDER_ASSEMBLY, UNIT_WATCHER, UNIT_SKY_BASE, UNIT_PORTAL],
    roleProtected: [UNIT_MONUMENT, UNIT_SPIDER_ASSEMBLY, UNIT_PORTAL, UNIT_SKY_BASE],
    ...
    roleUpper: [UNIT_MONUMENT, UNIT_SPIDER_ASSEMBLY, UNIT_WATCHER, UNIT_FF_GENERATOR, UNIT_SKY_BASE],
    roleFront: [UNIT_WATCHER],
    need: [UNIT_MONUMENT, UNIT_SPIDER_ASSEMBLY],
    gameWinners: [UNIT_MONUMENT, UNIT_PORTAL]
  }
)
