...
configRaces.set(
  RACE_HUMAN,
  {
    ...
    build: [UNIT_OUTPOST, UNIT_FORT, UNIT_FACTORY, UNIT_ASSEMBLY],
    roleProtected: [UNIT_OUTPOST, UNIT_FACTORY, UNIT_ASSEMBLY],
    roleMiddle: [UNIT_FORT, UNIT_OUTPOST, UNIT_FACTORY, UNIT_ASSEMBLY],
    roleEdge: [UNIT_FORT],
    roleUpperEdge: [UNIT_FORT],
    roleUpper: [UNIT_OUTPOST, UNIT_FACTORY, UNIT_ASSEMBLY],
